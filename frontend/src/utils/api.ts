...
export const API_ENDPOINTS = {
  ...
  allianceNationStats: (allianceIds: number[]) => `/api/alliance-nation-stats?allianceIds=${allianceIds.join(',')}`,
  ...
  mobilization: (allianceId: number, startDate?: string, endDate?: string) => {
  ...
  adminSetWarExcludedFromStats: (warId: number) => `/api/admin/wars/${warId}/excluded-from-stats`,
