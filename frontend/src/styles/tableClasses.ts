...
export const tableClasses = {
  ...
  filterInput: 'px-4 py-3 border-2 border-slate-400 rounded-lg text-base font-medium min-w-[200px] bg-white text-slate-800 placeholder-slate-500 focus:outline-none focus:border-secondary focus:ring-2 focus:ring-secondary/20 hover:border-slate-500',
