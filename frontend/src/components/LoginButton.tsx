...
const LoginButton: React.FC = () => {
  ...
  return (
    <button
      onClick={login}
      className="px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm bg-[#5865F2] text-white rounded hover:bg-[#4752C4] transition-colors whitespace-nowrap inline-flex items-center gap-1.5"
    >
      <svg
        viewBox="0 0 24 24"
