      ...
      <div className="flex flex-col gap-2 w-full sm:min-w-[280px]">
        ...
        <div className="block sm:hidden">
          {selectedAllianceNames.length > 0 ? (
            <div className="p-2 bg-blue-900/20 border border-blue-700 rounded-md">
            ...
            <div className="p-2 bg-gray-800 border border-gray-700 rounded-md">
              <div className="text-xs text-gray-400">No alliances selected</div>
            </div>
          )}
        </div>
      </div>
      <div className="text-xs text-gray-400 font-medium max-w-full sm:max-w-[140px] leading-tight">
        {placeholder}
      </div>
    </div>
  );
